...
Observations:
- There is a requirement to use a help function - I found the built in help() function and used that,
but I am not sure if this is the best way to do it. The help function we discussed in class seemed to be
for programs that accepted and documented command line arguments, which this program does not.
"""
